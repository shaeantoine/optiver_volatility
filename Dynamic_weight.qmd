...
for(i in 1:length(vol)){
  ...
  pred1_adjust[[i]]$fitted[1] <- mean(pred1[[1]]$fitted[1:30])
  pred1_adjust[[i]]$fitted[2] <- mean(pred1[[1]]$fitted[31:60])
  pred1_adjust[[i]]$fitted[3] <- mean(pred1[[1]]$fitted[61:91])
  pred1_adjust[[i]]$fitted[4] <- mean(pred1[[1]]$fitted[91:120])
}
pred1_adjust[[1]]
```
