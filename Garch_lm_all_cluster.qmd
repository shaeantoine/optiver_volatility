...
```{r,warning=FALSE,message=FALSE}
mse1_1 <- data_frame(MSE_mix1_1)
mse1_2 <- data_frame(MSE_mix1_2)
mse1_3 <- data_frame(MSE_mix1_3)
mse1_4 <- data_frame(MSE_mix1_4)
...
qle1_1 <- data_frame(QLIKE_mix1_1)
qle1_2 <- data_frame(QLIKE_mix1_2)
qle1_3 <- data_frame(QLIKE_mix1_3)
qle1_4 <- data_frame(QLIKE_mix1_4)
